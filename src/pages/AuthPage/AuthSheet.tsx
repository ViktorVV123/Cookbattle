...
export function AuthSheet({ open, initialMode, onClose }: Props) {
    ...
    // Синхронизируем режим при открытии шита с разной стороны (Войти / Начать готовить)
    useEffect(() => {
    ...
    return (
        <div className={styles.backdrop} onClick={onClose}>
            <div
                ...
                aria-modal="true"
            >
                {/* Handle сверху — визуальный признак что можно закрыть свайпом */}
                ...
                <div className={styles.content}>
                    {status === 'magicSent' || status === 'registerSent' ? (
                        <>
                        ...
                        <>
                            <h2 className={styles.heading}>
                                {mode === 'login' ? 'Вход' : mode === 'register' ? 'Создать аккаунт' : 'Вход по ссылке'}
                            </h2>
